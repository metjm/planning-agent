//! Workflow aggregate for event sourcing.
//!
//! The aggregate encapsulates all workflow state and enforces business rules
//! through command validation. State changes happen only through event application.
