...
impl Session {
    ...
    pub fn to_ui_state(&self) -> SessionUiState {
        SessionUiState {
            ...
            review_modal_open: self.review_modal_open,
            review_modal_scroll: self.review_modal_scroll,
    ...
    pub fn from_ui_state(ui_state: SessionUiState, workflow_state: Option<State>) -> Self {
        Self {
            ...
            // Review modal state - entries cleared on restore (re-loaded when modal opens)
